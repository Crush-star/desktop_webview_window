...
void WebviewWindowPlugin::HandleMethodCall(
  ...
  if (method_call.method_name() == "create") {
    ...
    auto isAlwayOnTop = std::get<bool>(arguments->at(flutter::EncodableValue("isAlwayOnTop")));
    ...
    window->CreateAndShow(
        ...
        int(windowPosX), int(windowPosY), useWindowPositionAndSize, isAlwayOnTop, openMaximized,
